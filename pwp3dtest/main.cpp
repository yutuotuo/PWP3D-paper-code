...
int main(void)
{
	...
	std::string sSrcImage = "../Files/Images/Red.png";
	std::string sCameraMatrix = "../Files/CameraCalibration/900nc.cal";
	std::string sTargetMask = "../Files/Masks/480p_All_VideoMask.png";
	std::string sHistSrc = "../Files/Masks/Red_Source.png";
	std::string sHistMask = "../Files/Masks/Red_Mask.png";
